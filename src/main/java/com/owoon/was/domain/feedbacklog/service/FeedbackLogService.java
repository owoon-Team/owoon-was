package com.owoon.was.domain.feedbacklog.service;
...
import com.owoon.was.domain.feedbacklog.repository.FeedbackLogRepository;
...
public class FeedbackLogService {
     ...
     */
    public List<FeedbackLogResponse> getFeedbackLogs(Long userId, Long sessionId, Long resultId) {
        validateUserExists(userId);
        validateRoutineExerciseResultExists(userId, sessionId, resultId);

        return feedbackLogRepository
                .findAllByRoutineExerciseResultIdAndRoutineExerciseResultRoutineSessionIdAndRoutineExerciseResultRoutineSessionUserIdOrderByCreatedAtAscIdAsc(
                        resultId,
                        sessionId,
                        userId
                )
